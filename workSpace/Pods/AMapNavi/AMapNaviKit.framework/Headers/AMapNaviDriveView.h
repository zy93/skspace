...
///地图是否自动切换白天黑夜模式,默认NO. 如果设置设置为YES，将会根据日出日落时间自动切换白天黑夜模式，可通过 -driveView:didChangeDayNightType: 获得切换时机 since 6.2.0
@property (nonatomic, assign) BOOL autoSwitchDayNightType;

///是否黑夜模式,默认NO. 如果autoSwitchDayNightType为YES，内部会自动对该值进行设置
