...
@interface SKSingleCirclesViewController ()<UITableViewDelegate,UITableViewDataSource,cellDelegate,InputDelegate,UIActionSheetDelegate>{
...
@implementation SKSingleCirclesViewController
