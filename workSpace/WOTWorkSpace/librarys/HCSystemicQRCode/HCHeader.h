...
#define kScrollLineHeight   10*ratio

#define kTipY               ([[UIScreen mainScreen] bounds].size.height-60*ratio)
#define kTipHeight          40*ratio

#define kLampX              ([[UIScreen mainScreen] bounds].size.width-kLampWidth)/2
#define kLampY              ([[UIScreen mainScreen] bounds].size.height-kLampWidth-60*ratio)
